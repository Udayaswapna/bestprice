  ...
  <div class="wrapper">
    ...
    <nav id="sidebarleft" class="sidenav">
      ...
      <ul class="list-unstyled components">
        ...
        <li>
          <a href="cart1.php"><i class="fas fa-home"></i> Cart</a>
        </li>
      </ul>
    </nav>
    <!-- .Sidebar left -->
        ...
        <div class="search-form">
          ...
          <ul class="right-menu">
            <li class="right-menu-item">
              <a href="#menu-dinner" data-toggle="collapse" aria-expanded="false" ><i class="fas fa-plus"></i>products <span><i class="fas fa-caret-down"></i></span></a>
              <ul class="collapse collapsible-body" id="menu-dinner">
                <li>
                  <a href="#">Rice<div class="count">3</div></a>
                </li>
                <li>
                  <a href="#">Dal & Pulses<div class="count">2</div></a>
                </li>
                <li>
                  <a href="#">Ghee & Oil<div class="count">32</div></a>
                </li>
                <li>
                  <a href="#">Atta & Flour<div class="count">32</div></a>
                </li>
                <li>
                  <a href="#">Noodles & Pastha<div class="count">32</div></a>
                </li>
                <li>
                  <a href="#">Dryfruits & Nuts<div class="count">32</div></a>
                </li>
                <li>
                  <a href="#">households<div class="count">32</div></a>
                </li>
                <li>
                  <a href="#">Dairy & Eggs<div class="count">32</div></a>
                </li>
              </ul>
            </li>
         ...
         <form method="post" action="cart1.php?action=add&id=<?php echo $row["id"]; ?>">
            <div class="row">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img src="images/<?php echo $row["image"]; ?>" class="d-block w-100" alt="First slide">
                                </div>
                    <div class="carousel-item">
                      <img src="images/<?php echo $row["image"]; ?>" class="d-block w-100" alt="Second slide">
                                </div>
                    <div class="carousel-item">
                      <img src="images/<?php echo $row["image"]; ?>" class="d-block w-100" alt="Third slide">
                                </div>
                  </div>
              ...
              <div class="col-md-7">
                ...
                <h2>  <?php echo '<span style="color:black; font-style:bold; font-size:25px;">' .$row["name"]; ?>
                </h2>
               

                <form method="POST">
                  <!--<div class="input-group">
                    <h> This Saffola oil will take care of you and your family by providing the benefits of natural antioxidants, MUFA, PUFA, and Vitamins A and D</h>
                  </div>-->
                  <br/>
                    <div class="input-group">
                    ...
                    <br/>
                      ...
                      <div>
                        NO: <input type='button' value='-' class='qtyminus' field='quantity' />
                        <input type='number'  name='quantity'  value='1' class='qty'id="quantity<?php echo $row["id"]; ?>"  />
